...
public class FlutterFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "997";
    private static final String NOTIFICATION_CHANNEL_NAME = "Alarm Notifications";
    private static final String NOTIFICATION_CHANNEL_DESC = "Alarm notifications";
